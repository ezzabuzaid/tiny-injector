...
export abstract class AppendTransientExtensions {
    /**
     * Append a transient service of the type specified in serviceType with a factory specified in implementationFactory.
     *
     * @description
    ...
    /**
     * Append a transient service of the injection token with a factory specified in implementationFactory
     *
     * @description
     * This method introduced because AddTransient will prevent the same injection token from being added twice
     *
     * You'll need to use {@Inject} decorator to resolve array of implementations.
     ...
     *
     */
    abstract AppendTransient<T extends InjectionToken<any>>(injectionToken: T, implementationFactory: (context: Context) => InjectionTokenGenericParam<T>): void;

    /**
     * Append a Transient service of the type specified in serviceType with an implementation of the type specified in implementationType.
     *
     * @description
     * Use this method when you want to have different implementations for the same serviceType
     *
    ...
    /**
     * Append a transient service of the type specified in serviceType.
     *
     * @description
     * Use this method when you want to have different implementations for the same serviceType
     *
