...
export abstract class ReplaceTransientExtensions {
     ...
     *
     */
    abstract ReplaceTransient<T extends InjectionToken<any>>(injectionToken: T, implementationFactory: (context: Context) => InjectionTokenGenericParam<T>): void;
     ...
     *
     */
    abstract ReplaceTransient<T extends ClassType<any>>(serviceType: T): void;
